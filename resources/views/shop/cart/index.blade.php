                ...
                <table class="table table-bordered" id="cart-summary">
                    ...
                    <tr>
                        <td class="cart-product">
                            <a href="#"><img alt="Blouse" src="/frontend/img/product/cart-image1.jpg"></a>
                        </td>
                    ...
                    <tr>
                        <td class="cart-product">
                            <a href="#"><img alt="Blouse" src="/frontend/img/product/cart-image2.jpg"></a>
                        </td>
                        <td class="cart-description">
                    ...
                    <tr>
                        <td class="cart-product">
                            <a href="#"><img alt="Blouse" src="/frontend/img/product/cart-image3.jpg"></a>
                        </td>
                        <td class="cart-description">
